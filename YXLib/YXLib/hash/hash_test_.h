...
#ifndef _YX_HASH_TEST_H_
#define _YX_HASH_TEST_H_
...
#define LODWORD(_val64_)         ((DWORD)(_val64_))

#endif

#if !defined(HIDWORD)

#define HIDWORD(_val64_)         ((DWORD)(((unsigned __int64)(_val64_) >> 32) & 0xFFFFFFFF))
...
inline DWORD Hash(unsigned __int64 u64)

{ return (DWORD)((HIDWORD(u64))^((DWORD)u64)); }


inline DWORD Hash(__int64 i64)

{ return (DWORD)((HIDWORD(i64))^((DWORD)i64)); }
