...
#define YX_MEMSECTION_BUFFLEN 1024
 ...
 */
#define yx_memsection_create_std() yx_memsection_create(yx_get_allocator(), YX_MEMSECTION_BUFFLEN)
...
void yx_memsection_freelarge(yx_allocator allocator, yx_ptr ptr); //无特殊情况不要调用，回遍历大内存数组，影响效率
