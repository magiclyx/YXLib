...
////////////////////////////////////////////////////////////////////////////////////////////////////
yx_forceinline
yx_ptr _yx_membucket_alloc(yx_core_mempool_cell_context* context)
{
...
yx_forceinline
void _yx_membucket_free(yx_core_mempool_cell_context* context, yx_ptr ptr)
{
...
yx_allocator yx_membucket_create(yx_allocator parentpool, yx_size cellSize)
{
    ...
    yx_allocator_setup(yx_rtti_allocator_membucket,
                       context,
...
{
    return _yx_membucket_alloc((yx_core_mempool_cell_context*)allocator);
}
           
void yx_membucket_free(yx_allocator allocator, yx_ptr ptr)
{
    _yx_membucket_free((yx_core_mempool_cell_context*)allocator, ptr);
}
...
yx_ptr _yx_cellMempool_std_alloc(yx_allocator allocator, yx_size size)
{
    ...
    return _yx_membucket_alloc(context);
}
...
void _yx_cellMempoo_std_free(yx_allocator allocator, yx_ptr address)
{
    ...
    _yx_membucket_free(context, address);
}
